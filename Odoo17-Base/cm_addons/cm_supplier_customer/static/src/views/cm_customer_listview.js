...
import { CmCustomerDashBoard } from '@cm_supplier_customer/views/cm_customer_dashboard';

export class CmCustomerDashBoardRenderer extends ListRenderer {};

CmCustomerDashBoardRenderer.template = 'cm_supplier_customer.CmCustomerListView';
