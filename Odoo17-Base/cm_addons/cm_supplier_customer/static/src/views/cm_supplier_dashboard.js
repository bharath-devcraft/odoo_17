...
export class CmSupplierDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.SupplierData = await this.orm.call("cm.supplier.customer", "supplier_retrieve_dashboard");
        });
    }
...
CmSupplierDashBoard.template = "cm_supplier_customer.CmSupplierDashBoard";
