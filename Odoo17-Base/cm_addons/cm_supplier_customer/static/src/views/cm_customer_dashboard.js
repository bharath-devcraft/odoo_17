...
export class CmCustomerDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.CustomerData = await this.orm.call("cm.supplier.customer", "retrieve_dashboard");
        });
    }
...
CmCustomerDashBoard.template = "cm_supplier_customer.CmCustomerDashBoard";
