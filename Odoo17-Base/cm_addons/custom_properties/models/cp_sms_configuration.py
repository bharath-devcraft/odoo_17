...
from odoo.addons.custom_properties.decorators import is_special_char,valid_mobile_no
...
class CpSmsConfiguration(models.Model):
    ...
    def _user_mobile_validation(self):
        ...
        invalid_mobile_numbers = [line.mobile_no for line in self.line_ids if line.mobile_no and not valid_mobile_no(line.mobile_no)]
