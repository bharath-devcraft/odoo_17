...
export class CmSurveyDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.masterData = await this.orm.call("cm.survey", "retrieve_dashboard");
        });
    }
...
CmSurveyDashBoard.template = "cm_survey.CmSurveyDashBoard";
