...
class CmLeasingTypeAttachmentLine(models.Model):
    _name = 'cm.leasing.type.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.leasing.type', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
