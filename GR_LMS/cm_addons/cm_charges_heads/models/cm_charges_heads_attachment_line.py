...
class CmChargesHeadsAttachmentLine(models.Model):
    _name = 'cm.charges.heads.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.charges.heads', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
