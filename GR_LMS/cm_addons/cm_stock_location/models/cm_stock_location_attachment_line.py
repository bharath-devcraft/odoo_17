...
class CmStockLocationAttachmentLine(models.Model):
    _name = 'cm.stock.location.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.stock.location', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
