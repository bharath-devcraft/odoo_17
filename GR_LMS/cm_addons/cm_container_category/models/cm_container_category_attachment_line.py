...
class CmContainerCategoryAttachmentLine(models.Model):
    _name = 'cm.container.category.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.container.category', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
