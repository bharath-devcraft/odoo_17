...
class CmMocAttachmentLine(models.Model):
    _name = 'cm.moc.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.moc', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
