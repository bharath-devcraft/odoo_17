...
class CmHsnCodeAttachmentLine(models.Model):
    _name = 'cm.hsn.code.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.hsn.code', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
