...
class CmDepotProductCleaningAttachmentLine(models.Model):
    _name = 'cm.depot.product.cleaning.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.depot.product.cleaning', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
