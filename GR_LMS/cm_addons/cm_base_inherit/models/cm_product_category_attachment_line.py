...
class CmProductCategoryAttachmentLine(models.Model):
    _name = 'cm.product.category.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('product.category', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
