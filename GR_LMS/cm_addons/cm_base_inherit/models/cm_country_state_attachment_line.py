...
class CmCountryStateAttachmentLine(models.Model):
    _name = 'cm.country.state.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('res.country.state', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
