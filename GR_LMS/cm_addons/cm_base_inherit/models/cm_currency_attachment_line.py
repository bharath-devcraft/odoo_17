...
class CmCurrencyAttachmentLine(models.Model):
    _name = 'cm.currency.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('res.currency', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
