...
class CmTaxGroupAttachmentLine(models.Model):
    _name = 'cm.tax.group.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('account.tax.group', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
