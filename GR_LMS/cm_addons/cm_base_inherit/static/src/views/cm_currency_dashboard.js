...
export class CmCurrencyDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.masterData = await this.orm.call("res.currency", "retrieve_dashboard");
        });
    }
...
CmCurrencyDashBoard.template = "cm_base_inherit.CmCurrencyDashBoard";
