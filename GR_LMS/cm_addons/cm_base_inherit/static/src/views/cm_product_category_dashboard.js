...
export class CmProductCategoryDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.masterData = await this.orm.call("product.category", "retrieve_dashboard");
        });
    }
...
CmProductCategoryDashBoard.template = "cm_base_inherit.CmProductCategoryDashBoard";
