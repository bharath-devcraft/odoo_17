...
class CmRejectionRemarkAttachmentLine(models.Model):
    _name = 'cm.rejection.remark.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.rejection.remark', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
