...
class CtQuotationSubmitExpensesLine(models.Model):
    _name = 'ct.quotation.submit.expenses.line'
    ...
    expense_id = fields.Many2one('cm.master', string="Expense", copy=False, ondelete='restrict', tracking=True, domain=[('status', '=', 'active'),('active_trans', '=', True)])
