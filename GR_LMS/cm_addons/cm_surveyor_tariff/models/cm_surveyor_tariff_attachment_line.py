...
class CmSurveyorTariffAttachmentLine(models.Model):
    _name = 'cm.surveyor.tariff.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.surveyor.tariff', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
