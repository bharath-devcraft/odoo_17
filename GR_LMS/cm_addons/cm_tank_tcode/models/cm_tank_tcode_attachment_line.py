...
class CmTankTcodeAttachmentLine(models.Model):
    _name = 'cm.tank.tcode.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.tank.tcode', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
