...
class CtCreditNoteDetailsLine(models.Model):
    _name = 'ct.credit.note.acc.details.line'
    _description = 'Details'
    _order = 'id asc'

    header_id = fields.Many2one('ct.credit.note.acc.line', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
