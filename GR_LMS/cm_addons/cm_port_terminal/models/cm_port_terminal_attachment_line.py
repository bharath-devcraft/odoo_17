...
class CmPortTerminalAttachmentLine(models.Model):
    _name = 'cm.port.terminal.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.port.terminal', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
