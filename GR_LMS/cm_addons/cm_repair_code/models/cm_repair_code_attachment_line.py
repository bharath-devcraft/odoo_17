...
class CmRepairCodeAttachmentLine(models.Model):
    _name = 'cm.repair.code.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.repair.code', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
