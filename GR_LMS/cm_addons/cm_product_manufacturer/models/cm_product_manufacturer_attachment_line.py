...
class CmProductManufacturerAttachmentLine(models.Model):
    _name = 'cm.product.manufacturer.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.product.manufacturer', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
