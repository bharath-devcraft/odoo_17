...
class CtQuotationsRepositionPricingDetailsLine(models.Model):
    _name = 'ct.quotations.reposition.pricing.details.line'
    _description = 'Re Positioning Pricing Details'
    _order = 'id asc'
