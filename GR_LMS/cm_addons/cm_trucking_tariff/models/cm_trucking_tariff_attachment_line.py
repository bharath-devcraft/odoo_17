...
class CmTruckingTariffAttachmentLine(models.Model):
    _name = 'cm.trucking.tariff.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.trucking.tariff', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
