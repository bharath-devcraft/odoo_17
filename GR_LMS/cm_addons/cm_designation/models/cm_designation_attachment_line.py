...
class CmDesignationAttachmentLine(models.Model):
    _name = 'cm.designation.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.designation', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
