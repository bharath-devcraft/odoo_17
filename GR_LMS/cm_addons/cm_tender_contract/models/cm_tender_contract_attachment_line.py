...
class CmTenderContractAttachmentLine(models.Model):
    _name = 'cm.tender.contract.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.tender.contract', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
