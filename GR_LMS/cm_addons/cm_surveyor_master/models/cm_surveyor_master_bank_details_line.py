...
class CmSurveyorMasterBankDetailsLine(models.Model):
    _name = 'cm.surveyor.master.bank.details.line'
    _description = 'Bank Details'
    _order = 'id asc'

    header_id = fields.Many2one('cm.surveyor.master', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
