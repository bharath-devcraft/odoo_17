...
class CtDisposalCertificateAttachmentLine(models.Model):
    _name = 'ct.disposal.certificate.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('ct.disposal.certificate', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
