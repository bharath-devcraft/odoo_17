...
class CmBranchAttachmentLine(models.Model):
    _name = 'cm.branch.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.branch', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
