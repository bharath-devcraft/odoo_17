...
class CmPortProductRestrictionAttachmentLine(models.Model):
    _name = 'cm.port.product.restriction.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.port.product.restriction', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
