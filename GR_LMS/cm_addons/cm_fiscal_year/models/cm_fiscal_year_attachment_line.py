...
class CmFiscalYearAttachmentLine(models.Model):
    _name = 'cm.fiscal.year.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.fiscal.year', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
