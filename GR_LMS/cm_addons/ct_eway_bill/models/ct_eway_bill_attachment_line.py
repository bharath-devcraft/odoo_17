...
class CtEwayBillAttachmentLine(models.Model):
    _name = 'ct.eway.bill.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('ct.eway.bill', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
