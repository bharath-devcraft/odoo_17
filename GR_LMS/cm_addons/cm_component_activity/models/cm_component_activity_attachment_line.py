...
class CmComponentActivityAttachmentLine(models.Model):
    _name = 'cm.component.activity.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.component.activity', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
