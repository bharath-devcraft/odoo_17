...
class CmDepartmentAttachmentLine(models.Model):
    _name = 'cm.department.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.department', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
