...
class CtStockLotAttachmentLine(models.Model):
    _name = 'ct.stock.lot.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('ct.stock.lot', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
