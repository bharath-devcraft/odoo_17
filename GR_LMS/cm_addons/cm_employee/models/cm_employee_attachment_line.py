...
class CmEmployeeAttachmentLine(models.Model):
    _name = 'cm.employee.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.employee', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
