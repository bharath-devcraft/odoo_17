...
class CmShipperInstructionAttachmentLine(models.Model):
    _name = 'cm.shipper.instruction.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.shipper.instruction', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
