...
class CmProductAttachmentLine(models.Model):
    _name = 'cm.product.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.product', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
