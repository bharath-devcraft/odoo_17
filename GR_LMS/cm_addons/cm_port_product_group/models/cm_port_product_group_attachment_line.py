...
class CmPortProductGroupAttachmentLine(models.Model):
    _name = 'cm.port.product.group.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.port.product.group', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
