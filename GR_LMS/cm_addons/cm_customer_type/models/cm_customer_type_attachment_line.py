...
class CmCustomerTypeAttachmentLine(models.Model):
    _name = 'cm.customer.type.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.customer.type', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
