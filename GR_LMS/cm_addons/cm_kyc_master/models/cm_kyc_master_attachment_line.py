...
class CmKycMasterAttachmentLine(models.Model):
    _name = 'cm.kyc.master.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.kyc.master', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
