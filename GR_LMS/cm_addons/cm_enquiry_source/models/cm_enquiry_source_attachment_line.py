...
class CmEnquirySourceAttachmentLine(models.Model):
    _name = 'cm.enquiry.source.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.enquiry.source', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
