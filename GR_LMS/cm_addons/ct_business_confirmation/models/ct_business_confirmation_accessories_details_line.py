...
class CtBusinessConfirmationAccessoriesDetailsLine(models.Model):
    _name = 'ct.business.confirmation.acc.details.line'
    _description = 'Details'
    _order = 'id asc'

    header_id = fields.Many2one('ct.business.confirmation.acc.line', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
