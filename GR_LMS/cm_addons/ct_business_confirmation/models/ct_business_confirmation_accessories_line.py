...
class CtBusinessConfirmationAccessoriesLine(models.Model):
    _name = 'ct.business.confirmation.acc.line'
    ...
    pending_qty = fields.Float(string="Pending Qty", digits=(2, 3))
    ...
    line_ids = fields.One2many('ct.business.confirmation.acc.details.line', 'header_id', string="Details", copy=True, c_rule=True)
