...
export class CharField extends Component {
    static template = "case_sensitive_widget.Auto_Trim_CharField";
    static components = {
        TranslationButton,
    };
    static props = {
    ...
    onInputChange(event) {
        ...
        if (input.type !== 'password') {
            ...
            if (input.value.trim() !== input.value) {
                this.showErrorMessage('No spaces allowed at the start or end of the input');
            }
...
registry.category("fields").add("auto_trim", charField);
