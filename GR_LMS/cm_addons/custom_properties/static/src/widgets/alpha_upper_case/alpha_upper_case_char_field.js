...
export class CharField extends Component {
    static template = "case_sensitive_widget.Alpha_Upper_Case_CharField";
    static components = {
        TranslationButton,
    };
    static props = {
    ...
    onInputChange(event) {
        ...
        if (input.type !== 'password') {
            ...
            if (input.value.replace(/[^a-zA-Z]/g, '') !== input.value) {
                this.showErrorMessage('Space or special characters is not allowed');
            }
            let newValue = input.value.toUpperCase().replace(/[^a-zA-Z]/g, '');
...
registry.category("fields").add("alpha_upper_case", charField);
