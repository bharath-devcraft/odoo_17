-- FUNCTION: public.csm_template()

-- DROP FUNCTION IF EXISTS public.csm_template();

CREATE OR REPLACE FUNCTION public.csm_template()
    RETURNS text
    LANGUAGE 'plpgsql'
    COST 100
...
v_net_amt = 0;
			...
			* {-webkit-font-smoothing: antialiased;}
			...
			#customers td,#customers th,#customers-campus td,#customers-campus th {border-left: 1px solid #71639e;border-right: 1px solid #71639e;border-top: 1px solid #71639e;padding: 8px;border-bottom: 1px solid #71639e;padding: 8px;}
			#customers th,#customers-campus th {font-weight: normal;background: #b0a8c1;}
			...
			<tr>
			<td style="width:100%; border-top-left-radius:10px; border-top-right-radius:10px" height="6" bgcolor="#71639e" class="contents">
			...
			<table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#71639e">
			<tr>
			...
			v_table_heading= v_table_heading || '<table id="customers" style="border:none;">
				<tr style="border:1px solid #71639e;"><td colspan="2" style="border:none;"><b style="margin-top: 15px;">Dear Sir / Mam</b>,</td></tr>
				<tr style="border-left:1px solid #71639e;border-right:1px solid #71639e;"><td colspan="26" style="border:none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>The following transaction has been approved.</span></td></tr></table>';
			...
			<tr>
                ...
                <th colspan="2"><b><center>Doc No</center></b></th>
                <th colspan="2"><b><center>Partner Name</center></b></th>
			...
			LOOP                 
		  		FETCH cursor_1 INTO v_trans_id,v_trans_name,v_division,v_department,v_supplier,v_line_count,v_trans_tot_amt;
            ...
            LOOP                 
                  FETCH cursor_2 INTO v_description,v_brand,v_uom,v_qty,v_disc_amt,v_tax_amt,v_unitprice,v_line_tot_amt;
	...
	v_data=v_data || '</tr>
			...
			<tr>
			<td>
				  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#71639e">
			<tr>
			<td height="2" align="center" bgcolor="#71639e" class="one-column"></td>
			</tr>
			<tr>
			<td align="center" bgcolor="#71639e" class="one-column" style="padding-top:0;padding-bottom:5px;padding-right:10px;padding-left:10px;"><font style="font-size:13px; text-decoration:none; color:white; font-family: Times New Roman; text-align:right;"> ** This mail is auto generated by ERP System </font></td>
			</tr>
			</table>
			</td>
			</tr>
...
ALTER FUNCTION public.csm_template()
    OWNER TO odoo;
