-- FUNCTION: public.ctm_quotation_revise_mail(integer, character, character, character)

-- DROP FUNCTION IF EXISTS public.ctm_quotation_revise_mail(integer, character, character, character);

CREATE OR REPLACE FUNCTION public.ctm_quotation_revise_mail(
	v_trans_id integer,
...
v_data='';
			...
			* {-webkit-font-smoothing: antialiased;}
			...
			trans.revise_remark as remark from  ct_quotations trans
			...
			LOOP                 
		  		FETCH cursor_1 INTO v_trans_name,v_entry_date,v_bkg_party,v_service_name,v_enquiry_no,v_net_amt,v_val_date,v_confirmed_by,v_approved_by,v_currency, v_remarks;
           ...
           if(v_trans_state in ('revised', 'original')) then
				v_table_heading= v_table_heading || '<tr style="border-left:1px solid #2f9780;border-right:1px solid #2f9780;"><td colspan="2" style="border:none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>The <b>'||v_ref_no||'</b> has been revised due to the below reason.</span></br></br><b> Remarks : '|| v_remarks ||'</b></td></tr>
				</table>';
		   else 
		       v_table_heading= v_table_heading || '<tr style="border-left:1px solid #2f9780;border-right:1px solid #2f9780;"><td colspan="2" style="border:none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>The detailsd of <b>'||v_ref_no||'</b> below, It has been created by '||v_user_name||'.</span></td></tr>
				</table>';
		      end if;
			...
			<tr>
			<td colspan="3"><b>Revised By</b></td>
...
ALTER FUNCTION public.ctm_quotation_revise_mail(integer, character, character, character)
    OWNER TO odoo;
