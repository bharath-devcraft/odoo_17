...
class CmDamageCodeAttachmentLine(models.Model):
    _name = 'cm.damage.code.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.damage.code', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
