...
class CmCalendarYearAttachmentLine(models.Model):
    _name = 'cm.calendar.year.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.calendar.year', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
