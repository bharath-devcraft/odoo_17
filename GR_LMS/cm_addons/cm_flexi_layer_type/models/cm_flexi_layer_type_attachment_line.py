...
class CmFlexiLayerTypeAttachmentLine(models.Model):
    _name = 'cm.flexi.layer.type.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.flexi.layer.type', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
