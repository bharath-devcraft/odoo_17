...
class CmIsoCodeAttachmentLine(models.Model):
    _name = 'cm.iso.code.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.iso.code', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
