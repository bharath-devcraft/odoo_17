...
class CmVehicleMakeAttachmentLine(models.Model):
    _name = 'cm.vehicle.make.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.vehicle.make', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
