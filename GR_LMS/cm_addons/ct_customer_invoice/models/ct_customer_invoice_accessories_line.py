...
class CtCustomerInvoiceAccessoriesLine(models.Model):
    _name = 'ct.customer.invoice.acc.line'
    ...
    line_ids = fields.One2many('ct.customer.invoice.acc.details.line', 'header_id', string="Details", copy=True, c_rule=True)
