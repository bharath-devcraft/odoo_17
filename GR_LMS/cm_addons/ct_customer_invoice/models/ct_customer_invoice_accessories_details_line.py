...
class CtCustomerInvoiceAccessoriesDetailsLine(models.Model):
    _name = 'ct.customer.invoice.acc.details.line'
    _description = 'Details'
    _order = 'id asc'

    header_id = fields.Many2one('ct.customer.invoice.acc.line', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
