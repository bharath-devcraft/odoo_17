...
class CtPaymentVoucherExpenseDetailsLine(models.Model):
    _name = 'ct.payment.voucher.expense.details.line'
    _description = 'Expense Details'
    _order = 'id asc'

    header_id = fields.Many2one('ct.payment.voucher', string="Header Ref", index=True, required=True, ondelete='cascade', c_rule=True)
