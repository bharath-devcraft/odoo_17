...
class CmCountryCodeAttachmentLine(models.Model):
    _name = 'cm.country.code.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.country.code', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
