...
class CmShipmentTermAttachmentLine(models.Model):
    _name = 'cm.shipment.term.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.shipment.term', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
