...
class CmBusinessVerticalSubTypeAttachmentLine(models.Model):
    _name = 'cm.business.vertical.sub.type.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.business.vertical.sub.type', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
