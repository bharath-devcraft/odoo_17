...
class CmVehicleTypeAttachmentLine(models.Model):
    _name = 'cm.vehicle.type.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.vehicle.type', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
