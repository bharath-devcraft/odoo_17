...
class CmCleaningCategoryAttachmentLine(models.Model):
    _name = 'cm.cleaning.category.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.cleaning.category', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
