...
class CmTaxMappingAttachmentLine(models.Model):
    _name = 'cm.tax.mapping.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.tax.mapping', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
