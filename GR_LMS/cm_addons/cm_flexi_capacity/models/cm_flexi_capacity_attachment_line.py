...
class CmFlexiCapacityAttachmentLine(models.Model):
    _name = 'cm.flexi.capacity.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.flexi.capacity', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
