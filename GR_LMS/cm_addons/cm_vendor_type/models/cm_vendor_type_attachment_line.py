...
class CmVendorTypeAttachmentLine(models.Model):
    _name = 'cm.vendor.type.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.vendor.type', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
