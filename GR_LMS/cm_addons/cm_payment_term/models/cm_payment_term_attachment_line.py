...
class CmPaymentTermAttachmentLine(models.Model):
    _name = 'cm.payment.term.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.payment.term', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
