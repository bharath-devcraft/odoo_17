...
class CmItemAttachmentLine(models.Model):
    _name = 'cm.item.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.item', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
