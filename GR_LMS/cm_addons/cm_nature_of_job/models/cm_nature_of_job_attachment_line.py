...
class CmNatureOfJobAttachmentLine(models.Model):
    _name = 'cm.nature.of.job.attachment.line'
    _description = 'Attachments'
    _order = 'attach_date desc'

    header_id = fields.Many2one('cm.nature.of.job', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
