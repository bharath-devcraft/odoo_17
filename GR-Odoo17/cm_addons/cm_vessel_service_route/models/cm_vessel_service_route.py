...
class CmVesselServiceRoute(models.Model):
    ...
    code = fields.Char(string="Service ID", copy=False)
    status = fields.Selection(selection=CUSTOM_STATUS, string="Status", copy=False, default="draft", readonly=True, store=True, tracking=True)
    inactive_remark = fields.Text(string="Inactive Remarks", copy=False)
    note = fields.Html(string="Notes", copy=False, sanitize=False)
    additional_note = fields.Html(string="Additional Notes", copy=False, sanitize=False)
    ...
    line_ids = fields.One2many('cm.vessel.service.route.line', 'header_id', string="Port Details", copy=True, c_rule=True)
