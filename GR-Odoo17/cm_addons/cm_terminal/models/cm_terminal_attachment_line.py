...
class CmTerminalAttachmentLine(models.Model):
    _name = 'cm.terminal.attachment.line'
    _description = 'Cm Terminal Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.terminal', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
