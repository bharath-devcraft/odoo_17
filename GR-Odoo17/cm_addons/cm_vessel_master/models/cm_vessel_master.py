...
class CmVesselMaster(models.Model):
    ...
    iom_number = fields.Integer(string="IMO Number", copy=False, size=7)
    flag_state_id = fields.Many2one('res.country', string="Flag State", ondelete='restrict')
    year_built = fields.Date(string="Year Built", copy=False)
