...
class CmCityAttachmentLine(models.Model):
    _name = 'cm.city.attachment.line'
    _description = 'Attachments'
    _order = 'id asc'

    header_id = fields.Many2one('cm.city', string="Header Ref",index=True, required=True, ondelete='cascade', c_rule=True)
