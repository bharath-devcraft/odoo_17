...
export class CmTaskGroupDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.masterData = await this.orm.call("cm.task.group", "retrieve_dashboard");
        });
    }
...
CmTaskGroupDashBoard.template = "cm_task_group.CmTaskGroupDashBoard";
