...
export class CmProfileMasterDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.profileMasterData = await this.orm.call("cm.profile.master", "retrieve_dashboard");
        });
    }
...
CmProfileMasterDashBoard.template = "cm_profile_master.CmProfileMasterDashBoard";
