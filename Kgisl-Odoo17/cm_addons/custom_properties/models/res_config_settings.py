...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
       ...
       self.env[IR_CONFIG_PARAMETER].sudo().set_param(DEL_DRAFT_ENTRY, self.del_draft_entry)
    ...
    def get_values(self):
       ...
       res.update(
           ...
           del_draft_entry=icp_sudo.get_param(DEL_DRAFT_ENTRY),
