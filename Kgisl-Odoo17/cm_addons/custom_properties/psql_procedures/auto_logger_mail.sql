...
v_sl_no =1;
			...
			* {-webkit-font-smoothing: antialiased;}
			...
			v_table_heading= v_table_heading || '<table id="customers" style="border:none;">
				...
				<tr style="border-left:1px solid #71639e;border-right:1px solid #71639e;"><td colspan="22" style="border:none;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span>The system facing the following errors in database '||v_db_name||', Kindly take necessary action.</span></td></tr></table>';
