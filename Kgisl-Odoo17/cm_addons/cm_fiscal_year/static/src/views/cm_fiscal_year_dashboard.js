...
export class CmFiscalYearDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.masterData = await this.orm.call("cm.fiscal.year", "retrieve_dashboard");
        });
    }
...
CmFiscalYearDashBoard.template = "cm_fiscal_year.CmFiscalYearDashBoard";
