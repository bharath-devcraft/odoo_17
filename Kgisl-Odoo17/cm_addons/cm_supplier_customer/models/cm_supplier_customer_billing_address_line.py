...
class CmSupplierCustomerBillingAddressLine(models.Model):
    _name = 'cm.supplier.customer.billing.address.line'
    ...
    def _check_effective_date(self):
        if self.effective_date:
            ...
            from cm_supplier_customer_billing_address_line where effective_date='%s' 
