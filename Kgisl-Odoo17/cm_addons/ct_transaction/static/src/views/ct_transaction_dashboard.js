...
export class CtTransactionDashBoard extends Component {
    setup() {
        this.orm = useService("orm");
        this.action = useService("action");

        onWillStart(async () => {
            this.transactionData = await this.orm.call("ct.transaction", "retrieve_dashboard");
        });
    }
...
CtTransactionDashBoard.template = "ct_transaction.CtTransactionDashBoard";
